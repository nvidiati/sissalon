                        ...
                        <div class="row">
                            ...
                            <div class="row Deal-form">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="discount_type" id="discount_type" class="form-control">
                                            ...
                                            <option @if ($deal->discount_type!='percentage') selected @endif value="{{ $settings->currency->currency_name }}"> @lang('app.fix') @lang('app.amount') </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="daterange" name="applied_between_dates" autocomplete="off" value="{{ $dateTime['start_date_time'] }}--{{ $dateTime['end_date_time'] }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group time-picker">
                                        ...
                                        <input type="text" class="form-control" id="open_time" name="open_time" autocomplete="off" value="{{ $dateTime['open_time'] }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group time-picker">
                                        ...
                                        <input type="text" class="form-control" id="close_time"  name="close_time" autocomplete="off" value="{{ $dateTime['close_time'] }}">
                                    </div>
                                </div>
                            ...
                            <input type="hidden" name="deal_startDate" id="deal_startDate" value="{{ $dateTime['start_date_time'] }}">
                            <input type="hidden" name="deal_endDate" id="deal_endDate" value="{{ $dateTime['end_date_time'] }}">
                            <input type="hidden" name="deal_startTime" id="deal_startTime" value="{{ $dateTime['open_time'] }}">
                            <input type="hidden" name="deal_endTime" id="deal_endTime" value="{{ $dateTime['close_time'] }}">
                        </div>
                    </form>
                </div>
                <!-- /.card-body -->
