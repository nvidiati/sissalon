<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{$user->is_superadmin || $user->is_agent ? route('superadmin.todo-items.index') : route('admin.todo-items.index') }}" class="btn btn-sm btn-custom">
...
<div id="upper-box" class="todo-box mb-3">
    ...
    <ul class="list-group px-3 py-2" id="pending-tasks">
        @forelse ($pendingTodos as $todo)
            <li data-id="{{ $todo->id }}" data-position="{{ $todo->position }}" class="draggable list-group-item todo">
                <div class="handle">
        ...
        @empty
            <li class="list-group-item  todo" id="no-pending-task">
                <h6 class="card-title">
...
<div id="lower-box" class="todo-box">
    ...
    <ul class="list-group px-3 py-2" id="completed-tasks">
        ...
        @empty
            <li class="list-group-item todo" id="no-completed-task">
                <h6 class="card-title">
