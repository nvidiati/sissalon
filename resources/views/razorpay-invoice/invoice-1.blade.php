...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr id="pb">
            ...
            <td class="qty"></td>
            <td class="unit">{{ $global->currency->currency_code }}{{ number_format((float)$invoice->amount, 2, '.', '') }}</td>
        </tr>
        </tbody>
        <tfoot>
        <tr dontbreak="true">
            <td colspan="4">@lang("modules.invoices.total")</td>
            <td id="tac">{{ $global->currency->currency_code }}{{ number_format((float)$invoice->amount, 2, '.', '') }}</td>
        </tr>
        </tfoot>
    </table>
</main>
