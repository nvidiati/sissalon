                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="latitude" class="form-control form-control-lg" name="lat"  value="{{ $location->lat }}" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('app.longitude') <span class="required-span">*</span></label>
                                    <input type="text" id="longitude" class="form-control form-control-lg" name="lng"  value="{{ $location->lng }}" autocomplete="off">
                                </div>
                            </div>
        ...
        <script src="{{ asset('js/locationpicker.jquery.js') }}"></script>
            <script>
                    ...
                    $('.googlemap').locationpicker({
                        location: {
                            latitude: {{ $location->lat?$location->lat:'26.85259403535702' }},
                            longitude: {{ $location->lng?$location->lng:'26.85259403535702' }}
                        },
                        radius: 0,
                        zoom: 4,
                        inputBinding: {
