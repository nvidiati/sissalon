<html>
   ...
   <body>
      <!-- Page Content -->
      <div class="container">
         <div class="row" id="mt-30p">
            <div class="text-center m-t-20 mt-20 bg-primary" id="p-20">
               <img class="text-center" src="{{ asset('assets/img/logo.png') }}" id="mw-240" alt="Home"/>
            </div>
            <div class="bs-example" data-example-id="alerts-with-links" id="alerts-with-links">
